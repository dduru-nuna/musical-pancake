...
public class Demo {
	...
	public static void main(String[] args) {
		 ...
		 *    - 동일 객체 뿐 아니라 동등 객체도 중복하여 저장하지 않는다. (객체 주소, 값 둘 다 중복x)
		 *    
		 * LinkedHashSet
		...
		System.out.println("컬렉션에 데이터가 비어 있는가? : " + isEmpty);
		
		// 컬렉션에 데이터가 몇 개 있는지 확인
		int size = aSet.size();
		System.out.println("데이터 갯수 : " + size);
		
		// set 수정하고 싶으면 기존 데이터 삭제하고 새롭게 추가하는 형식으로 해야함
