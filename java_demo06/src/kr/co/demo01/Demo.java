...
public class Demo {
	...
	public static void main(String[] args) {
		/*
		 * 객체
		 *    현실 세계에서는 사물이나 개념처럼 독립되고 구분되는 각각의 객체로
		 *    이루어져 있으며, 발생하는 모든 사건들은 객체간의 상호작용으로
		 *    이루어져 있다. 이러한 개념을 컴퓨터로 옮겨 유사하게 동작하도록
		 *    만든 것을 객체지향 언어라고 한다.
		 *    
		 *    예시
		 *    고객 정보를 관리하는 프로그램을 만들려고 할 때 프로그램에서 요구하는
		 *    "고객" 이라는 객체는 현실 세계의 "고객"을 추상화(객체화) 하여
		 *    사용하게 된다
		 *    
		 *    현실 세계의 고객
		...
		Customer cs1 = new Customer();   // cs1 은 인스턴스 변수
