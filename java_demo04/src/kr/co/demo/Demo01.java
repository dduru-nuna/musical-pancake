	...
	public static void main(String[] args) {
		...
		*/
		...
		if(x3 < 10) {
			...
			System.out.println("변수 x3에 저장된 정수값은 30 이상이고 40 보다 작습니다.");
		} else {
		...
		*/
		...
		if(x4 < 10) {
			if(x4 % 2 == 0) {
				System.out.println("변수 x4에 저장된 정수값은 10보다 작은 짝수 입니다.");
			} else {
				System.out.println("변수 x4에 저장된 정수값은 10보다 작은 홀수 입니다.");
			}
		} else {
			System.out.println("변수 x4에 저장된 정수값은 10보다 큽니다.");
		}
